...
* Mailcow - Email, CalDAV, CardDAV (see [TODO section](#todo))
...
| **App**               | **Platform** | **App**                                                          | **Description/Notes**                                                                                                                                                                                                                                                                                                                                                |
| --------------------- | ------------ | ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| **Calendar/Contacts** | Android      | DAVx⁵                                                            | This will be managed through CalDAV and CardDAV, however, I didn't find a service yet on the server (see [TODO section](#todo)).                                                                                                                                                                                                                                     |
|                       | Linux        | Integrated into DE                                               | Gnome automatically supports and integrates CalDAV and CardDAV into their apps.                                                                                                                                                                                                                                                                                      |
...
|                       | Android      | Immich                                                           | Need to host the "additional" service to use, does not support WebDAV                                                                                                                                                                                                                                                                                                |
...
I still am trying to figure out which service to use for self-hosting email, calendars and contacts. Please email me if you have any suggestions but before doing so, make sure to check that it adhere's to the requirements I defined above. I will update this article if I end up using them and give credit where it's due.

I'm currently thinking of Mailcow but I've never self-hosted email so I will take it slow.

---

## Don't Touch Nextcloud

![Nextcloud](articles/images/nextcloud-logo-blue-transparent.svg)
